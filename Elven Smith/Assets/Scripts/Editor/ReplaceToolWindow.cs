...
public class ReplaceToolWindow : EditorWindow
{
    ...
    //Prefab variable from data object. Using SerializedProperty fo integrated UNDO.
    ...
    private void OnGUI()
    {
        ...
        //Title for section with object to replace.
        ...
        {
            EditorGUILayout.Separator();
            EditorGUILayout.LabelField("Select object or objects in hierarchy to replace them", EditorStyles.wordWrappedLabel);
        }
        ...
        {
            //Check if replace object is assignd.
            ...
            //Check if there are object to replace.
    ...
    private void InitDataIfNeeded()
    {
        ...
        //If prefab field was not assigned as SerializedProperty, assign i.
